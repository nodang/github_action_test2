...
;	..\Compiler\bin\opt2000.exe C:\Users\nodang\AppData\Local\Temp\TI18810 C:\Users\nodang\AppData\Local\Temp\TI1884 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\nodang\AppData\Local\Temp\TI1882 --template_info_file C:\Users\nodang\AppData\Local\Temp\TI1886 --object_file extremerun.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
