...
;	..\Compiler\bin\opt2000.exe C:\Users\nodang\AppData\Local\Temp\TI33610 C:\Users\nodang\AppData\Local\Temp\TI3364 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\nodang\AppData\Local\Temp\TI3362 --template_info_file C:\Users\nodang\AppData\Local\Temp\TI3366 --object_file DSP280x_Spi.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_SpiTx
...
DW$5	.dwtag  DW_TAG_subprogram, DW_AT_name("SpiTx"), DW_AT_symbol_name("_SpiTx")
	...
	.dwattr DW$5, DW_AT_begin_line(0xa1)
	.dwattr DW$5, DW_AT_begin_column(0x08)
	.dwpsn	"DSP280x_Spi.c",162,1
...
_SpiTx:
;*** 163	-----------------------    C$1 = &SpiaRegs;
;*** 163	-----------------------    (*C$1).SPITXBUF = Buf<<8;
;*** 164	-----------------------    *((volatile struct _SPISTS_BITS *)C$1+2L) |= 0x20u;
...
DW$8	.dwtag  DW_TAG_variable, DW_AT_name("Buf"), DW_AT_symbol_name("_Buf")
	...
	.dwpsn	"DSP280x_Spi.c",163,2
        MOV       ACC,AL << #8          ; |163| 
        MOVB      XAR0,#8               ; |163| 
        MOVL      XAR4,#_SpiaRegs       ; |163| 
        MOV       *+XAR4[AR0],AL        ; |163| 
	.dwpsn	"DSP280x_Spi.c",164,2
        OR        *+XAR4[2],#0x0020     ; |164| 
L1:    
DW$L$_SpiTx$2$B:
;***	-----------------------g2:
;*** 165	-----------------------    if ( !(*(&SpiaRegs+2L)&0x40u) ) goto g2;
	.dwpsn	"DSP280x_Spi.c",165,8
        MOVW      DP,#_SpiaRegs+2
        TBIT      @_SpiaRegs+2,#6       ; |165| 
        BF        L1,NTC                ; |165| 
        ; branchcc occurs ; |165| 
DW$L$_SpiTx$2$E:
;*** 167	-----------------------    return SpiaRegs.SPIRXBUF&0xffu;
	.dwpsn	"DSP280x_Spi.c",167,2
        AND       AL,@_SpiaRegs+7,#0x00ff ; |167| 
	.dwpsn	"DSP280x_Spi.c",168,1
        LRETR
        ; return occurs

DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\Users\nodang\Desktop\2809_MICROMOUSE\2809_hara\main\DSP280x_Spi.asm:L1:1:1718521227")
	.dwattr DW$9, DW_AT_begin_file("DSP280x_Spi.c")
	.dwattr DW$9, DW_AT_begin_line(0xa5)
	.dwattr DW$9, DW_AT_end_line(0xa5)
DW$10	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$5, DW_AT_end_line(0xa8)
...
;***	-----------------------g2:
;***  	-----------------------    C$1 = &GpioDataRegs;
;***  	-----------------------    ((volatile unsigned *)C$1)[3] |= 0x8u;
;*** 51	-----------------------    Delay(49152uL);
;***  	-----------------------    ((volatile unsigned *)C$1)[5] |= 0x8u;
;*** 54	-----------------------    Delay(49152uL);
;*** 56	-----------------------    *&SpiaRegs |= 0x80u;
;*** 58	-----------------------    SpiTx(215u);
;*** 59	-----------------------    StatusReg = SpiTx(0u);
;***  	-----------------------    *(&GpioDataRegs+3L) |= 0x8u;
;*** 62	-----------------------    Delay(49152uL);
...
;***  	-----------------------    return;
	...
	.dwpsn	"DSP280x_Spi.c",51,3
        MOV       ACC,#3 << 14
        LCR       #_Delay               ; |51| 
        ; call occurs [#_Delay] ; |51| 
        OR        *+XAR3[5],#0x0008
	.dwpsn	"DSP280x_Spi.c",54,3
        MOV       ACC,#3 << 14
        LCR       #_Delay               ; |54| 
        ; call occurs [#_Delay] ; |54| 
	.dwpsn	"DSP280x_Spi.c",56,3
        MOVW      DP,#_SpiaRegs
        OR        @_SpiaRegs,#0x0080    ; |56| 
	.dwpsn	"DSP280x_Spi.c",58,3
        MOVB      AL,#215               ; |58| 
        LCR       #_SpiTx               ; |58| 
        ; call occurs [#_SpiTx] ; |58| 
	.dwpsn	"DSP280x_Spi.c",59,3
        MOVB      AL,#0
        LCR       #_SpiTx               ; |59| 
        ; call occurs [#_SpiTx] ; |59| 
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0008
        MOVZ      AR1,AL                ; |59| 
...
DW$14	.dwtag  DW_TAG_loop
	.dwattr DW$14, DW_AT_name("C:\Users\nodang\Desktop\2809_MICROMOUSE\2809_hara\main\DSP280x_Spi.asm:L2:1:1718521227")
	.dwattr DW$14, DW_AT_begin_file("DSP280x_Spi.c")
	.dwattr DW$14, DW_AT_begin_line(0x30)
...
DW$16	.dwtag  DW_TAG_subprogram, DW_AT_name("SpiWriteRom"), DW_AT_symbol_name("_SpiWriteRom")
	...
	.dwattr DW$16, DW_AT_begin_line(0x75)
	.dwattr DW$16, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Spi.c",118,1
...
;*** 141	-----------------------    *&SpiaRegs |= 0x80u;
;*** 143	-----------------------    SpiTx(130u);
;*** 144	-----------------------    SpiTx(PageAdd>>7&3u);
;*** 145	-----------------------    SpiTx(PageAdd*2u&0xffu|BufAdd>>8&1u);
;*** 146	-----------------------    SpiTx(BufAdd&0xffu);
;*** 148	-----------------------    if ( !Number ) goto g4;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
        MOVL      *SP++,XAR1
...
DW$27	.dwtag  DW_TAG_variable, DW_AT_name("L$1"), DW_AT_symbol_name("L$1")
	...
	.dwattr DW$27, DW_AT_location[DW_OP_reg14]
        ...
        MOV       *-SP[1],AR5           ; |118| 
        MOVZ      AR3,AH                ; |118| 
	.dwpsn	"DSP280x_Spi.c",125,2
        LCR       #_SpiBusyOK           ; |125| 
        ; call occurs [#_SpiBusyOK] ; |125| 
	...
	.dwpsn	"DSP280x_Spi.c",146,2
        AND       AL,AR3,#0x00ff        ; |146| 
        LCR       #_SpiTx               ; |146| 
        ; call occurs [#_SpiTx] ; |146| 
	.dwpsn	"DSP280x_Spi.c",148,13
        MOV       AL,*-SP[1]
        BF        L4,EQ                 ; |148| 
        ; branchcc occurs ; |148| 
...
;*** 123	-----------------------    i = 0u;
        ADDB      AL,#-1
        MOVZ      AR5,AL
	.dwpsn	"DSP280x_Spi.c",123,9
        MOVB      XAR1,#0
L3:    
DW$L$_SpiWriteRom$3$B:
;***	-----------------------g3:
;*** 150	-----------------------    SpiTx(pBuf[i]&0xffu);
;*** 148	-----------------------    ++i;
;*** 148	-----------------------    if ( (--L$1) != (-1) ) goto g3;
	.dwpsn	"DSP280x_Spi.c",150,3
        AND       AL,*+XAR2[AR1],#0x00ff ; |150| 
        LCR       #_SpiTx               ; |150| 
        ; call occurs [#_SpiTx] ; |150| 
	.dwpsn	"DSP280x_Spi.c",148,25
        ADDB      XAR1,#1               ; |148| 
	.dwpsn	"DSP280x_Spi.c",148,13
        BANZ      L3,AR5--              ; |148| 
        ; branchcc occurs ; |148| 
...
;*** 155	-----------------------    return;
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0008
	.dwpsn	"DSP280x_Spi.c",155,2
        MOV       ACC,#3 << 14
        LCR       #_Delay               ; |155| 
        ; call occurs [#_Delay] ; |155| 
	.dwpsn	"DSP280x_Spi.c",158,1
        SUBB      SP,#4
	.dwcfa	0x1d, -8
        MOVL      XAR3,*--SP
	.dwcfa	0x1d, -6
...
DW$28	.dwtag  DW_TAG_loop
	.dwattr DW$28, DW_AT_name("C:\Users\nodang\Desktop\2809_MICROMOUSE\2809_hara\main\DSP280x_Spi.asm:L3:1:1718521227")
	.dwattr DW$28, DW_AT_begin_file("DSP280x_Spi.c")
	.dwattr DW$28, DW_AT_begin_line(0x94)
	.dwattr DW$28, DW_AT_end_line(0x98)
DW$29	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$16, DW_AT_end_line(0x9e)
...
;*** 91	-----------------------    *&SpiaRegs |= 0x80u;
;*** 93	-----------------------    SpiTx(210u);
;*** 94	-----------------------    SpiTx(PageAdd>>7&3u);
;*** 95	-----------------------    SpiTx(PageAdd*2u&0xffu|BufAdd>>8&1u);
;*** 96	-----------------------    SpiTx(BufAdd&0xffu);
;*** 98	-----------------------    SpiTx(0u);
;*** 99	-----------------------    SpiTx(0u);
;*** 100	-----------------------    SpiTx(0u);
;*** 101	-----------------------    SpiTx(0u);
...
DW$41	.dwtag  DW_TAG_variable, DW_AT_name("L$1"), DW_AT_symbol_name("L$1")
	...
	.dwattr DW$41, DW_AT_location[DW_OP_reg16]
        ...
        MOV       *-SP[1],AR5           ; |68| 
        MOVZ      AR3,AH                ; |68| 
	.dwpsn	"DSP280x_Spi.c",75,2
        LCR       #_SpiBusyOK           ; |75| 
        ; call occurs [#_SpiBusyOK] ; |75| 
        MOVL      XAR4,#_GpioDataRegs
        MOVL      *-SP[4],XAR4
        OR        *+XAR4[3],#0x0008
...
;*** 103	-----------------------    if ( !Number ) goto g4;
	.dwpsn	"DSP280x_Spi.c",103,13
        MOV       AL,*-SP[1]
        BF        L6,EQ                 ; |103| 
        ; branchcc occurs ; |103| 
;***  	-----------------------    #pragma MUST_ITERATE(1, 4294967295, 1)
...
;*** 105	-----------------------    pBuf[i] = SpiTx(0u);
;*** 103	-----------------------    ++i;
;*** 103	-----------------------    if ( (--L$1) != (-1) ) goto g3;
	.dwpsn	"DSP280x_Spi.c",105,3
        MOVB      AL,#0
        LCR       #_SpiTx               ; |105| 
        ; call occurs [#_SpiTx] ; |105| 
        MOV       *+XAR2[AR1],AL        ; |105| 
	.dwpsn	"DSP280x_Spi.c",103,25
        ADDB      XAR1,#1               ; |103| 
	.dwpsn	"DSP280x_Spi.c",103,13
        BANZ      L5,AR6--              ; |103| 
        ; branchcc occurs ; |103| 
...
;*** 110	-----------------------    return;
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0008
	.dwpsn	"DSP280x_Spi.c",110,2
        MOV       ACC,#3 << 14
        LCR       #_Delay               ; |110| 
        ; call occurs [#_Delay] ; |110| 
...
DW$42	.dwtag  DW_TAG_loop
	.dwattr DW$42, DW_AT_name("C:\Users\nodang\Desktop\2809_MICROMOUSE\2809_hara\main\DSP280x_Spi.asm:L5:1:1718521227")
	.dwattr DW$42, DW_AT_begin_file("DSP280x_Spi.c")
	.dwattr DW$42, DW_AT_begin_line(0x67)
	.dwattr DW$42, DW_AT_end_line(0x6b)
DW$43	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$30, DW_AT_end_line(0x71)
