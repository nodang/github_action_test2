...
;	..\Compiler\bin\opt2000.exe C:\Users\nodang\AppData\Local\Temp\TI46810 C:\Users\nodang\AppData\Local\Temp\TI4684 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\nodang\AppData\Local\Temp\TI4682 --template_info_file C:\Users\nodang\AppData\Local\Temp\TI4686 --object_file DSP280x_PieVect.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$68	.dwtag  DW_TAG_loop
	.dwattr DW$68, DW_AT_name("C:\Users\nodang\Desktop\2809_MICROMOUSE\2809_hara\main\DSP280x_PieVect.asm:L1:1:1718521227")
